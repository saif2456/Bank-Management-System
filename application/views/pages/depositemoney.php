...
<body data-spy="scroll">
	...
	<div  class="container-fluid signin_div" style="margin-top: 70px; overflow-y: scroll;">
		<div class="container">
			<!--tittle-->
			<h1 class="title" align="center">Money Deposite</h1>
...
?>
					<!--deposite form -->
					<form action="<?php echo base_url()?>index.php/depositemoney_submit" method="post" accept-charset="utf-8">
						<div class="col-xs-4 col-sm-4 col-lg-4 col-md-4">
							<!--account input -->
							<p class="Days_later2">Deposite account number</p>
						...
						<div class="col-xs-4 col-sm-4 col-lg-4 col-md-4">
							<!--Submit Button -->
							<br><br>
							<label  class="Days_later2"><input class="form-control Days_later2" type="submit" name="submit" value="Deposite Money"></label>
							<!--Submit Button end  -->
						</div>
