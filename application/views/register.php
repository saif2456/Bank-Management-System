...
<body>
	...
	<div class="container-fluid signin_div">
		<!--Sign in Tittle-->
		<p class="title" style="text-align: center;">Sign up to online banking</p><br>
		<div class="container">
			<div class="form-group">
				<div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
					<!--Form Strat .. -->
					<form class="form-horizontal" action="<?php echo base_url()?>index.php/insert_user" method="post" align="center" >
						<!--Account Label Start-->
						<label >
...
?>
							...
							<br>
								<!--sign up label-->
								<label><p class="menu_font"><a class="foget_hover" href="<?php echo base_url();?>">Have account ? log in</a></p></label><br>
								<!--sign up label end-->
								<!--login input label -->
								<label  class="Days_later" style="width: 300px;"><input class="form-control Days_later2" type="submit" name="submit" value="Sign up"></label>
								<!--login input label -->
							</div>
