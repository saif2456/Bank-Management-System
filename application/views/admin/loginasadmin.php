...
<body>
	...
	<div class="container-fluid signin_div">
		<!--Sign in Tittle-->
		<p class="title" style="text-align: center;">Admin Panel</p><br>
		<div class="container">
			<div class="form-group">
				<div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
					<!--Form Strat .. -->
					<form class="form-horizontal" action="<?php echo base_url()?>index.php/admin_login_process" method="post" align="center" >
						<!--Account Label Start-->
						<label >
...
?>
                 ...
                 <br>
                   <!--sign up label-->
                   <label><p class="menu_font2"><a class="foget_hover" href="<?php echo base_url();?>">Not admin ? login as customer ?</a></p></label><br>
                   <!--sign up label end-->
                   <!--login input label -->
