...
<body data-spy="scroll">
	...
	<div  class="container-fluid signin_div" style="margin-top: 70px; overflow-y: scroll;">
		<div class="container">
			<h1 class="title" align="center">update their account balance</h1>
...
<?php foreach ($data as $row) {
	...
	echo "<p class='Days_later2'>".$row['nid']."</p>";
						...
						<div class="col-xs-2 col-md-2 col-lg-2 col-sm-2">
							<p class="Days_later2">click to change</p>
<?php foreach ($data as $row) {
	$id  = $row['id'];
	$url = base_url().'index.php/addmoney?id='.$id;

	echo "<P><a class='Days_later2' href='$url'>" ."Click Here</a><p>";
